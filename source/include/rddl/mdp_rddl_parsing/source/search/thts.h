...
private:
    ...
    bool continueTrial(SearchNode* /*node*/) {
        return ((numDecisionNodes < maxDecisionNodes) &&
                initializedDecisionNodes < numberOfNewDecisionNodesPerTrial);
    }
    ...
    size_t numDecisionNodes;
    size_t numChanceNodes;
    size_t maxDecisionNodes;
